...
from seabinv import SingleChain
...
class MCMC_Optimizer(object):
    ...
    def _init_chain(self, chainidx, targets):
        chain = SingleChain(
            ...
            sharednoise=self.sharednoise, sharedtemperatures=self.sharedtemperatures,
    ...
    def monitor_process(self, dtsend):
        ...
        noise = np.frombuffer(self.sharednoise, dtype=dtype) \
            .reshape((self.nchains, self.nmodels, 2))
